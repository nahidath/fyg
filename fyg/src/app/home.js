            ...
            <div className={styles.bg}>
                <div className={styles.navbar}>
                    <div className={styles.ellipseParent}>
                        <img className={styles.blackAndWhiteCollection191} alt="" src="Black and White Collection 19.svg" />
                ...
                <div className={styles.headerTxt}>
                    <div className={styles.discoverAndFind1}>Discover and find your future game</div>
            ...
            <div className={styles.div2}>
                ...
                <div className={styles.div3}>
                    ...
                    <div className={styles.fluentgiftCard20FilledParent}>
                        <img className={styles.fluentgiftCard20FilledIcon1} alt="" src="cib_xbox.svg" />
                        <div className={styles.steam}>XBOX</div>
                    </div>
                    <div className={styles.cibepicGamesParent}>
                        <img className={styles.cibepicGamesIcon1} alt="" src="cib_epic-games.svg" />
